...
const routes = [
  ...
  { path: '/news', name: 'News', meta: { name: '多智鲁班' }, component: () => import('../views/manager/News') },
  { path: '/login', name: 'Login', meta: { name: '登录' }, component: () => import('../views/Login.vue') },
  { path: '/register', name: 'Register', meta: { name: '注册' }, component: () => import('../views/Register.vue') },
  { path: '*', name: '404', meta: { name: '无法访问' }, component: () => import('../views/404.vue') },
  { path: '/cad', name: 'Cad', meta: { name: 'CAD展示' }, component: () => import('../views/manager/Cad.vue') },
